...
public class BeforeLapsComparatorTest extends TestCase {
    private BeforeLapsComparator comparator = null;
    ...
    public void test_isEqual_number() throws Exception {
        ...
        assertFalse(comparator.isEqual(new BigDecimal("150"), new BigDecimal("160"), 0));
    ...
    protected void setUp() throws Exception {
        super.setUp();
        comparator = new BeforeLapsComparator();
    }
