 ...
 */
public class AfterLapsComparatorTest extends TestCase {
    private AfterLapsComparator comparator = null;
    ...
    public void test_isEqual_number() throws Exception {
        ...
        assertFalse(comparator.isEqual(new BigDecimal("150"), new BigDecimal("140"), 0));
    ...
    protected void setUp() throws Exception {
        super.setUp();
        comparator = new AfterLapsComparator();
    }
